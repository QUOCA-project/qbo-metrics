...
The code accepts daily or monthly input data. Monthly means are the
recommended input for composites. The loader resamples daily data to monthly
means before compositing. The example uses available daily data for the period
estimate. It otherwise calculates every diagnostic from monthly composites.
...
An example minimal data file \texttt{qbo\_metrics\_example\_data.nc} is included in the GitHub repository,
